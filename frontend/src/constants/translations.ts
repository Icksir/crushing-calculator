...
export const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    meta_title: "Kamaskope - Dofus Rune Calculator and Forgemagia Prices",
    meta_description: "Rune calculator and forgemagia prices for Dofus. Optimize your profits by crushing items and managing your resources with updated coefficients.",
    logo_alt_text: "Kamaskope Logo",
  ...
  fr: {
    ...
    meta_description: "Calculateur de runes et prix de forgemagie pour Dofus. Optimisez vos gains en concassant des objets et gérant vos ressources avec des coefficients à jour.",
